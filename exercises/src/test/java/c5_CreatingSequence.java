...
public class c5_CreatingSequence {
    ...
    public void trouble_maker() {
        Mono<String> trouble = Mono.error(new IllegalStateException("all hands abandon ship")); //todo: change this line
